...
APP_NAME="UltraStarDeluxe"
REPO="UltraStar-Deluxe/USDX"
AMD_SUFFIX=".AppImage"
ARM_SUFFIX=""
LOGO_URL="https://hansimcklaus.iwr.sh/post/how-to-create-a-song-for-ultrastar-deluxe-updated/img/UltraStarDeluxe.jpg"
...
export DISPLAY=:0.0
export HOME=/userdata/system/add-ons/ultrastardeluxe
