...
* ***Atualização - 08.06.2025 - Versão 7.5***
    ...
    * **O Screenrec agora conta com uma função para capturar o áudio pelo seu microfone. (P.S.: Por padrão, a caixa de seleção vem desmarcada, ou seja, desativada, para utilizar o microfone durante suas gravações, basta marcar a caixa antes de inicar as gravações de tela)*
