...
ARM_SUFFIX=""
LOGO_URL="https://github.com/batocera-unofficial-addons/batocera-unofficial-addons/raw/main/freedroidrpg/extra/freedroidrpg-logo.jpg"
...
if [ -x "\${app_image}" ]; then
    cd "\${app_dir}"
    ./${APP_NAME,,}.AppImage --fullscreen "\$@" > "\${log_file}" 2>&1
