...
APP_NAME="Hydra Launcher"
REPO="hydralauncher/hydra"
AMD_SUFFIX="hydralauncher-3.1.5.AppImage"
ARM_SUFFIX=""
LOGO_URL="https://github.com/DTJW92/batocera-unofficial-addons/raw/main/hydralauncher/extra/hydralauncher-logo.png"
