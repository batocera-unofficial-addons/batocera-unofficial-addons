...
URL="https://github.com/trashbus99/profork/releases/download/r1/spelunky.wsquashfs"
...
APP_NAME="Spelunky"
LOGO_URL="https://github.com/DTJW92/batocera-unofficial-addons/raw/main/windows/extra/spelunky.jpg"
LOGO_PATH="/userdata/roms/windows/images/spelunky-logo.jpg"
...
xmlstarlet ed -s "/gameList" -t elem -n "game" -v "" \
  -s "/gameList/game[last()]" -t elem -n "path" -v "./spelunky.wsquashfs" \
  -s "/gameList/game[last()]" -t elem -n "name" -v "$APP_NAME" \
  -s "/gameList/game[last()]" -t elem -n "image" -v "./images/spelunky-logo.jpg" \
