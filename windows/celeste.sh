...
URL="https://github.com/batocera-unofficial-addons/batocera-unofficial-addons/releases/download/AppImages/Celeste.wsquashfs"
...
APP_NAME="Celeste"
LOGO_URL="https://github.com/batocera-unofficial-addons/batocera-unofficial-addons/raw/main/windows/extra/celeste.jpg"
LOGO_PATH="/userdata/roms/windows/images/celeste-logo.jpg"
...
xmlstarlet ed -s "/gameList" -t elem -n "game" -v "" \
  -s "/gameList/game[last()]" -t elem -n "path" -v "./Celeste.wsquashfs" \
  -s "/gameList/game[last()]" -t elem -n "name" -v "$APP_NAME" \
  -s "/gameList/game[last()]" -t elem -n "image" -v "./images/celeste-logo.jpg" \
