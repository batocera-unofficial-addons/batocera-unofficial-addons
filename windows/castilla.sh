...
URL="https://github.com/batocera-unofficial-addons/batocera-unofficial-addons/releases/download/AppImages/maldita_castilla.wsquashfs"
...
APP_NAME="Maldita Castilla"
LOGO_URL="https://github.com/batocera-unofficial-addons/batocera-unofficial-addons/raw/main/windows/extra/maldita-castilla.jpg"
LOGO_PATH="/userdata/roms/windows/images/mc-logo.jpg"
...
xmlstarlet ed -s "/gameList" -t elem -n "game" -v "" \
  -s "/gameList/game[last()]" -t elem -n "path" -v "./maldita_castilla.wsquashfs" \
  -s "/gameList/game[last()]" -t elem -n "name" -v "$APP_NAME" \
  -s "/gameList/game[last()]" -t elem -n "image" -v "./images/mc-logo.jpg" \
