...
URL="https://github.com/batocera-unofficial-addons/batocera-unofficial-addons/releases/download/AppImages/sonic-triple-trouble.wsquashfs"
...
LOGO_URL="https://github.com/batocera-unofficial-addons/batocera-unofficial-addons/raw/main/windows/extra/sonic.jpg"
...
xmlstarlet ed -s "/gameList" -t elem -n "game" -v "" \
  -s "/gameList/game[last()]" -t elem -n "path" -v "./sonic-triple-trouble.wsquashfs" \
  -s "/gameList/game[last()]" -t elem -n "name" -v "$APP_NAME" \
  -s "/gameList/game[last()]" -t elem -n "image" -v "./images/stt-logo.jpg" \
