...
PORT_SCRIPT="/userdata/roms/ports/Twitch.sh"
ICON_PATH="/userdata/roms/ports/images/twitch-logo.png"
KEYS_PATH="/userdata/roms/ports/Twitch.sh.keys"
LOGO_URL="https://github.com/batocera-unofficial-addons/batocera-unofficial-addons/raw/main/twitch/extra/twitch-logo.png"
...
cat << EOF > $PORT_SCRIPT
#!/bin/bash
DISPLAY=:0.0 $APPPATH --no-sandbox --test-type --start-fullscreen --force-device-scale-factor=1.6 'twitch.tv'
EOF
