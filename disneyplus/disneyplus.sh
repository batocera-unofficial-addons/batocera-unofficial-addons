...
LOGO_URL="https://github.com/DTJW92/batocera-unofficial-addons/raw/main/disneyplus/extra/disneyplus-logo.png"
...
xmlstarlet ed -s "/gameList" -t elem -n "game" -v "" \
  ...
  -s "/gameList/game[last()]" -t elem -n "image" -v "./images/disneyplus-logo.jpg" \
